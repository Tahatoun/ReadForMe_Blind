...
public class FilesActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        profileCall2.enqueue(new Callback<Blind>() {
            ...
            public void onResponse(Call<Blind> call, Response<Blind> response) {
                if(response.isSuccessful()){
                    try {
                        ...
                        e.printStackTrace();
                        Toast.makeText(FilesActivity.this, "Application Error "+response.code(), Toast.LENGTH_SHORT).show();
                    }
                }else{
            ...
            public void onFailure(Call<Blind> call, Throwable t) {
                Toast.makeText(FilesActivity.this, R.string.network_error, Toast.LENGTH_LONG).show();
                t.printStackTrace();
                ...
                if ((lastInScreen == totalItemCount) && !(loadingMore)) {
                    ...
                    if (!(search)) {
                        if (home.getCurrent_page() == home.getLast_page()) {
                            Toast.makeText(FilesActivity.this, "No More Files ", Toast.LENGTH_SHORT).show();
                        } else {
                            loadingMore = true;
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case R.id.newFileItem: intent=new Intent(FilesActivity.this,UploadFileActivity.class); break;
            case R.id.allFilesItem: intent=new Intent(FilesActivity.this,FilesActivity.class); break;
            case R.id.myFilesItem: intent=new Intent(FilesActivity.this,MyFilesActivity.class); break;
            case R.id.myProfileItem: intent=new Intent(FilesActivity.this,MyFilesActivity.class); break;
            case R.id.logoutItem:
                authManager.deleteToken();
                intent=new Intent(FilesActivity.this,LoginActivity.class);
                break;
    ...
    protected void homeContent(int pageIndex){
        profileCall = Util.getBlindService(this).getHomeContent(pageIndex);
